...
import pinterLogo from "@/public/icon-pinterest.svg";
import fbLogo from "@/public/icon-facebook.svg";
...
const Footer = () => {
  ...
  return (
    <div className="mx-auto  flex  max-w-screen-xl flex-col items-center gap-y-10 p-5 text-center md:flex-row md:items-start md:justify-between md:text-left">
      ...
      <div className="flex flex-col gap-x-16 gap-y-14 md:flex-row">
        {data.map((d, i) => (
          <div key={i}>
            ...
            <div className="mt-3 flex flex-col gap-y-3">
              {d.links.map((link, i) => (
                <a
                  href="#"
                  className="text-white/70 hover:text-cyan-500"
                  key={i}
                >
                  {link}
                </a>
      ...
      <div className="flex cursor-pointer gap-5">
        ...
        <Image src={pinterLogo} alt="pinterest logo" />
